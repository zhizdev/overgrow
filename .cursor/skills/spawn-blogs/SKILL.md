...
- Follow the project's voice if a brand voice doc exists (check `.cursorrules`, `BRAND.md`, `VOICE.md`, `style-guide.md`). Otherwise default to clear, active, jargon-light.
