...
If the user provided arguments via `$ARGUMENTS`, parse them to determine the page type and company/product. Otherwise, STOP and call the AskUserQuestion tool to clarify.

Also check CLAUDE.md for any project-level conventions, brand guidelines, or design system details.
