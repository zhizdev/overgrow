...
If the user provided arguments via `$ARGUMENTS`, parse them to determine the page type and company/product. Otherwise, {{ask_instruction}}

Also check {{config_file}} for any project-level conventions, brand guidelines, or design system details.
