...
3. Parse `$ARGUMENTS`: if a page type, audience, or vertical seed is given, scope to it. Otherwise propose 3-5 candidate pages to spawn and {{ask_instruction}} which to run.
...
- Follow the project's voice (check `{{config_file}}`, `BRAND.md`, `VOICE.md`). Default to clear, active, jargon-light.
